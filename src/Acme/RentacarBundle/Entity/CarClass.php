...
class CarClass
{
     ...
     * @var string
     *
     * @ORM\Column(name="price3", type="decimal", precision=10, scale=0, nullable=false)
     */
    private $price3;
     ...
     * @var string
     *
     * @ORM\Column(name="price6", type="decimal", precision=10, scale=0, nullable=false)
     */
    private $price6;
     ...
     * @var string
     *
     * @ORM\Column(name="price12", type="decimal", precision=10, scale=0, nullable=false)
     */
    private $price12;
     ...
     * @var string
     *
     * @ORM\Column(name="price24", type="decimal", precision=10, scale=0, nullable=false)
     */
    private $price24;
     ...
     * @var string
     *
     * @ORM\Column(name="insurance_price", type="decimal", precision=10, scale=0, nullable=false)
     */
